...
public abstract class Tuple4f implements Serializable {
	...
	private static final long serialVersionUID = 8372304750275139140L;
    ...
    public final void set(Tuple4d t1) {
    	...
    	this.set((float)t1.x, (float)t1.y, (float)t1.z, (float)t1.w);
    }
     ...
     */
    public final boolean equals(Tuple4f t1) {
     ...
     */
    public final boolean epsilonEquals(Tuple4f t1, float epsilon) {
